...
export const SUBSCRIPTION_KINDS = ['HOSTING', 'MENTENANTA', 'HOSTING_MENTENANTA'] as const;
export const PRODUCTS = ['LANDING_PAGE', 'PREZENTARE', 'ECOMMERCE', 'CRM', 'ERP', 'ALTUL'] as const;
